...
const TokenDetails = () => {
  ...
  // Display logic: show first 10 or all
  const displayedHolders = showAllHolders
    ? filteredHolders
    : filteredHolders.slice(0, initialLimit);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden mb-6">
          ...
          <div className="overflow-x-auto">
            ...
            {/* View All Button for Holders */}
            {!showAllHolders && filteredHolders.length > initialLimit && (
              <div className="flex justify-center py-4">
                <button
                  onClick={() => setShowAllHolders(true)}
                  className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
                >
                  View All Holders ({filteredHolders.length})
                </button>
              </div>
            )}
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
          ...
          <div className="overflow-x-auto">
            ...
            {/* View All Button for Transfers */}
            {!showAllTransfers && filteredTransfers.length > initialLimit && (
              <div className="flex justify-center py-4">
                <button
                  onClick={() => setShowAllTransfers(true)}
                  className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
                >
                  View All Transfers ({filteredTransfers.length})
                </button>
              </div>
            )}
          </div>
